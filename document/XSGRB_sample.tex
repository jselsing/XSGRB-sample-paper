...
\keywords{Gamma-ray burst: general --- Galaxies: high-redshift --- ISM: general --- Techniques: spectroscopic}
...
Benetti), 091.A-0877 (PI: Schady), 092.D-0056 (PI: Rau), 092.D-0633 (PI:
...
\begin{figure*}[!h]
	\centering
	\includegraphics[page=6, width=16cm]{figures/HI_measurements.pdf}
	\caption*{Fig. \ref{fig:HI1}. continued.}
	\label{fig:HI6}
\end{figure*}
\clearpage
...
10^{21}$~cm$^{-2}$ (see e.g. \citealt{Campana2012}). Alternatively, the

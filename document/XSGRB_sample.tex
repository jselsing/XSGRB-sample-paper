...
It is clear, however, that the fraction of dark bursts among which we have taken
a spectrum is lower than the intrinsic dark burst fraction, as we need a
detected afterglow to obtain a spectrum. In addition, it is more difficuly to
...
presence of an optical afterglow affects the follow-up statistics. 50 percent of
all \textit{Swift}-detected bursts do not have an detected optical afterglow,
but this number also includes bursts where no optical telescopes were available,
so it is a lower limit. For the bursts entering our statistical sample, this
number is $\sim$ 27 percent, which is close to the maximum fraction of dark
bursts expected for the parent population of long GRBs \citep{Melandri2012}. Of
the bursts for which follow-up has actually been attempted, this number is
$\sim$ 18 percent, confirming that we are indeed biased against bursts without
an optical afterglow in the spectroscopic sample.
...
bursts to have a higher \nx~is real, that the decreased fraction of dark bursts
...
measured \nx is primarily driven by a high column local to the burst. Because we
only use values of \nx~in the comparison for which the GRB has a measured

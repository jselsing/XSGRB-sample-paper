...
mainly with FORS1/2 and X-shooter \citep[see][]{Fynbo2009, Jakobsson2012, Kruhler2012}(see Fynbo et al.\ 2009, ApJS, 185, 526; 
...
of this subset has previously been investigated \citep{DePasquale2003,
...
"darkness"-parameter, $\beta_{OX}$ \citep{Milvang-Jensen2012}. This required the
...
correctly associating a galaxy with a burst when there is no detected optical afterglow
is more difficult, meaning that we should not have attempted follow-up for a
larger fraction of bursts with no optical afterglow. The X-ray properties for
the followed sample does not differ signicantly from the statistical sample, as
shown in Sect. \ref{completeness}. Using the table maintained by
Greiner\footnote{http://www.mpe.mpg.de/~jcg/grbgen.html} \todo{How to reference
this}, we can see how the pressence of an optical afterglow affects the
follow-up statistics. 50.5 percent of all \textit{Swift}-detected bursts do not
have an detected optical afterglow, but this number also includes bursts where
no optical telescopes were available, so is a lower limit. For the bursts
entering our statistical sample, this number is 27 percent

Since \textit{all} GRBs should have an optical afterglow, the presence of an optical afterglow is more a statement about the sensitivity than optical properties of the bursts. 

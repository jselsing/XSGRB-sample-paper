...
\title{XS-GRB I - The X-shooter GRB afterglow sample
\thanks{Based on observations collected at the European Southern Observatory, Paranal, 
	Chile, Program IDs: 098.A-0055, 097.A-0036, 096.A-0079, 095.B-0811(B), 
...
\abstract{In this work we present spectra of all $\gamma$-ray burst (GRB)
	afterglows that have been promptly observed with VLT/X-shooter up to
	...
	of observational selection criteria that are unbiased with regards to intrinsic
	properties of the GRBs, the follow-up effort has been guided by the
	\textit{Swift}-telescope to produce a homogeneous sample of spectra for 91 GRBs.
	We here provide a public release of all the reduced spectra, including continuum
	estimates and telluric corrections. For completeness, we also provide reductions
	for the late-time observations of the underlying host galaxies. We provide an
	...
	find that the sample presented here is representative of the full \textit{Swift}
	sample. For all bursts (41) for which it is possible, we provide a measurement
	of the neutral hydrogen column density, increasing the total number of published
	HI column density measurements by $\sim$ 50 per cent. %	We constrain the
	% fraction
	...
	from the local progenitor surroundings to the galaxy wide conditions}
...
0.02 nm/pixel and a 0\farcs16 per pixel spatial sampling for the UVB and VIS
arm and 0.06 nm/pixel with a 0\farcs21 per pixel in the NIR arm.  Because

...
presented here. We have developed an algorithm that attempts to automatically
find the continuum placement along with the error on the continuum estimate. For
each arm,

...
afterglows that have \textit{ever} been observed at the VLT/X-shooter. This
...
We constrain the fraction of dark burst to be 27\% - 42\% and confirm previous
results that higher optical darkness has increased X-ray excess
absorption.
...
Since \textit{all} GRBs should have an optical afterglow, the presence of an optical afterglow is more a statement about the sensitivity than optical properties of the bursts. \todo{Daniele, help.}

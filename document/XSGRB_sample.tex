...
alpha absorption line is randomly superposed with forest systems, making it
notoriously difficult to model. Similarly so, the red wing has got the ISM
signatures imprinted on it, especially strong absorption due to \SIii~which can
exhibit significant velocity structure. Along with instrumental effects, the
...
\begin{figure*}
	...
	\caption{Same as Fig. \ref{fig:HI1}}
	\label{fig:HI2}
\end{figure*}

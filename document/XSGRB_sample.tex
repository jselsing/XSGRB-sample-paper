...
which we will derive statistical properties of the GRB population. From this
sample, 90 GRBs have been spectroscopically followed up with X-shooter. In order
to assess whether the subset of bursts followed up are representative of the
...
% Text for redshift distribution section

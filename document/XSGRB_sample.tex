...
\abstract{In this work we present the spectra of all $\gamma$-ray bursts (GRBs)
	...
	published HI column density measurements by $\sim$ 50 \%. We constrain the
	fraction of dark bursts to be 27\% - 42\% \todo{Preliminary} and tentatively
	confirm previous results that larger optical darkness is correlated with
	increased X-ray absorption. This dataset provides a unique possibility to study
	the ISM across cosmic time. 
...
For 8 of the observed GRBs in the spectra released here, RRM triggered. One of
...
years 2009 -- 2017 to use the X-shooter spectrograph on the ESO-VLT to secure
...
galaxies \citep{Kruhler2015}, the frequency of intervening \ion{Mg}{ii}
absorbers \citep{Christensen2017}, and escape of ionizing radiation
\citep{Tanvir2017}.

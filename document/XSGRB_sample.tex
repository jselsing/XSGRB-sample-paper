...
We constrain the fraction of dark burst to be 27\% - 42\% \todo{Preliminary} and 
tentatively confirm previous
results that larger optical darkness leads is correlated with increased X-ray absorption.
...
\begin{figure*}
	...
	\caption{Redshift distribution of the XSGRB sample.}
	\label{fig:z}
\end{figure*}

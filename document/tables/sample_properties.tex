\begin{table*}[!ht]
	...
	\end{tabular}
	\caption{Population properties (median and 14th and 86th percentiles as the
	...
	conserve the statistical properties of the underlying population, as least for these parameters.  \label{tab:sample_properties}} \end{table*}
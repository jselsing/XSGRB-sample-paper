...
\title{The X-shooter GRB afterglow legacy sample (XS-GRB)\thanks{Based on
		...
		Programme IDs: 084.A-0260, 084.D-0265, 085.A-0009, 086.A-0073, 087.A-0055,
...
\abstract{In this work we present spectra of all $\gamma$-ray burst (GRB)
	...
	of observational selection criteria that minimise biases with regards to
	...
	is representative of the full \textit{Swift} sample. We have constrained the fraction
	...
	bursts for which it is possible, we have provided a measurement of the neutral
